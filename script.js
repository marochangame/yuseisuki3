(() => {
  ...
  const pairs = [
    ...
    {category:"くだもの", a:{id:"pear", name:"なし", emoji:"🍐"}, b:{id:"mango", name:"マンゴー", emoji:"🥭"}},
    {category:"くだもの", a:{id:"blueberry", name:"ブルーベリー", emoji:"🫐"}, b:{id:"coconut", name:"ココナッツ", emoji:"🥥"}},
    {category:"おやつ", a:{id:"cupcake", name:"カップケーキ", emoji:"🧁"}, b:{id:"pie", name:"パイ", emoji:"🥧"}},
    {category:"おやつ", a:{id:"pancake", name:"パンケーキ", emoji:"🥞"}, b:{id:"waffle", name:"ワッフル", emoji:"🧇"}},
    {category:"おやつ", a:{id:"popcorn", name:"ポップコーン", emoji:"🍿"}, b:{id:"shavedice", name:"かきごおり", emoji:"🍧"}},
    {category:"おやつ", a:{id:"softcream", name:"ソフトクリーム", emoji:"🍦"}, b:{id:"dango", name:"だんご", emoji:"🍡"}},
    {category:"ごはん", a:{id:"spaghetti", name:"スパゲッティ", emoji:"🍝"}, b:{id:"bento", name:"おべんとう", emoji:"🍱"}},
    {category:"ごはん", a:{id:"sandwich", name:"サンドイッチ", emoji:"🥪"}, b:{id:"taco", name:"タコス", emoji:"🌮"}},
    {category:"ごはん", a:{id:"gyoza", name:"ぎょうざ", emoji:"🥟"}, b:{id:"friedshrimp", name:"エビフライ", emoji:"🍤"}},
    {category:"ごはん", a:{id:"friedchicken", name:"からあげ", emoji:"🍗"}, b:{id:"steak", name:"ステーキ", emoji:"🥩"}},
    {category:"ごはん", a:{id:"egg", name:"たまご", emoji:"🥚"}, b:{id:"cheese", name:"チーズ", emoji:"🧀"}},
    {category:"ごはん", a:{id:"rice", name:"ごはん", emoji:"🍚"}, b:{id:"noodles", name:"めん", emoji:"🍜"}},
    {category:"やさい", a:{id:"tomato", name:"トマト", emoji:"🍅"}, b:{id:"cucumber", name:"きゅうり", emoji:"🥒"}},
    {category:"やさい", a:{id:"potato", name:"じゃがいも", emoji:"🥔"}, b:{id:"onion", name:"たまねぎ", emoji:"🧅"}},
    {category:"やさい", a:{id:"pepper", name:"ピーマン", emoji:"🫑"}, b:{id:"mushroom", name:"きのこ", emoji:"🍄"}},
    {category:"のみもの", a:{id:"tea", name:"おちゃ", emoji:"🍵"}, b:{id:"cocoa", name:"ココア", emoji:"☕"}},
    {category:"のみもの", a:{id:"soda", name:"ソーダ", emoji:"🥤"}, b:{id:"water", name:"おみず", emoji:"💧"}},
    ...
    {category:"どうぶつ", a:{id:"deer", name:"しか", emoji:"🦌"}, b:{id:"zebra", name:"しまうま", emoji:"🦓"}},
    {category:"どうぶつ", a:{id:"hippo", name:"かば", emoji:"🦛"}, b:{id:"rhino", name:"さい", emoji:"🦏"}},
    {category:"どうぶつ", a:{id:"gorilla", name:"ゴリラ", emoji:"🦍"}, b:{id:"orangutan", name:"オランウータン", emoji:"🦧"}},
    {category:"どうぶつ", a:{id:"camel", name:"らくだ", emoji:"🐫"}, b:{id:"llama", name:"ラマ", emoji:"🦙"}},
    {category:"どうぶつ", a:{id:"kangaroo", name:"カンガルー", emoji:"🦘"}, b:{id:"sloth", name:"ナマケモノ", emoji:"🦥"}},
    {category:"どうぶつ", a:{id:"otter", name:"カワウソ", emoji:"🦦"}, b:{id:"beaver", name:"ビーバー", emoji:"🦫"}},
    {category:"どうぶつ", a:{id:"hedgehog", name:"ハリネズミ", emoji:"🦔"}, b:{id:"squirrel", name:"リス", emoji:"🐿️"}},
    {category:"どうぶつ", a:{id:"seal", name:"アザラシ", emoji:"🦭"}, b:{id:"polarbear", name:"しろくま", emoji:"🐻‍❄️"}},
    {category:"どうぶつ", a:{id:"eagle", name:"わし", emoji:"🦅"}, b:{id:"flamingo", name:"フラミンゴ", emoji:"🦩"}},
    {category:"どうぶつ", a:{id:"duck", name:"あひる", emoji:"🦆"}, b:{id:"swan", name:"はくちょう", emoji:"🦢"}},
    {category:"どうぶつ", a:{id:"peacock", name:"くじゃく", emoji:"🦚"}, b:{id:"turkey", name:"しちめんちょう", emoji:"🦃"}},
    {category:"どうぶつ", a:{id:"wolf", name:"おおかみ", emoji:"🐺"}, b:{id:"leopard", name:"ひょう", emoji:"🐆"}},
    {category:"どうぶつ", a:{id:"crocodile", name:"ワニ", emoji:"🐊"}, b:{id:"snake", name:"へび", emoji:"🐍"}},
    {category:"どうぶつ", a:{id:"lizard", name:"とかげ", emoji:"🦎"}, b:{id:"bat", name:"こうもり", emoji:"🦇"}},
